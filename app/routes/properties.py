...
def build_property_response(prop: dict) -> PropertyResponse:
    ...
    return PropertyResponse(
        ...
        property_type_id=str(prop["property_type_id"]) if prop.get("property_type_id") else "",
        ...
        listed_by=str(prop["listed_by"]) if prop.get("listed_by") else "",
...
async def toggle_property_status(property_id: str, current_user: dict = Depends(get_current_user)):
    ...
    # Anything that is not "inactive" gets toggled to "inactive", and vice versa
